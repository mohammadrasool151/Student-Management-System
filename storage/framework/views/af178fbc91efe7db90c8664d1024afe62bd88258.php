...
<table class="table" id='myTable'>
    ...
    <tbody>
        <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
            <td><?php echo e($c->id); ?></td>
            <td><?php echo e($c->name); ?></td>
           
            <td> <img src="<?php echo e(asset('uploaded_img')); ?>/<?php echo e($c->img); ?>" alt="" height='150' width='150'></td> 
            <td><?php echo e($c->phone); ?></td>
            <td><?php echo e($c->myCourse[0]->Course_Name); ?> </td> 
            <td><?php echo e($c->myCourse[0]->Batch_Time); ?> </td> 
            <td><?php echo e($c->myCourse[0]->Teaching_Day); ?> </td> 
           
            <td><a href="javascript:void(0)" data-id="<?php echo e($c->course_id); ?>" class='btn btn-warning showEditModal'>Edit</a></td>

            <td>
            
            <form action="student/<?php echo e($c->id); ?>" method='POST'>
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <option  selected disabled> -</option>
                <?php $__currentLoopData = $course; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                
    <option value="<?php echo e($cse->id); ?>"><?php echo e($cse->Course_Name); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <option value=""></option>
            </select>
        </div>
...
<?php /**PATH C:\Users\moham\OneDrive\Desktop\Student-Management-System\resources\views/showAllStudent.blade.php ENDPATH**/ ?>